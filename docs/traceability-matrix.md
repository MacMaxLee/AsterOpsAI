...
| FR-PERF-005 | No component of host or database scoring, or of bottleneck | n/a | `rust_core/core/src/analysis/host.rs` | none | NEEDS-VERIFICATION |
...
| FR-POL-002 | Risk level, together with environment (§18), determines whether an | n/a | `rust_core/core/src/policy/evaluate.rs` | none | NEEDS-VERIFICATION |
...
| FR-SEC-004 | No response action may disable a firewall or antivirus product; this | U11 | `rust_core/core/src/security/mod.rs` | none | NEEDS-VERIFICATION |
