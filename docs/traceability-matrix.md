...
| FR-CORR-003 | Correlation output uses the same contract types the console and the | U70 | `rust_core/core/src/correlation/mod.rs` | `rust_core/service/tests/ai_endpoints.rs` | OK |
...
**Summary**: 60 OK, 3 NEEDS-VERIFICATION, 0 MISSING (of 63 total FR-IDs).
