...
import 'memory_history_point.dart';

final class HistoryResponseForMemoryHistoryPoint {
  final List<MemoryHistoryPoint> points;
  final DateTime requestedFrom;
  final DateTime requestedTo;
  final HistoryTier resolvedTier;
  final DateTime? truncatedFrom;

  const HistoryResponseForMemoryHistoryPoint({
  ...
  static HistoryResponseForMemoryHistoryPoint fromJson(dynamic json) {
    final map = json as Map<String, dynamic>;
    return HistoryResponseForMemoryHistoryPoint(
      points: (map['points'] as List<dynamic>)
          .map((e) => MemoryHistoryPoint.fromJson(e))
          .toList(),
